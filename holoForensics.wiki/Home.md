...
- **Live evidence packaging** for high-value Windows artifacts including Registry hives, Event Logs, Prefetch, browser artifacts, Jump Lists, LNK Files, `$MFT`, `$LogFile`, INDX records, SRUM, and `$UsnJrnl`.
