...
- In archive collection, reuses the shared VSS snapshot when `$LogFile` is collected with `$MFT`, INDX, SRUM, Registry, USN, EVTX, Browser Artifacts, Jump Lists, or LNK Files for the same volume.
