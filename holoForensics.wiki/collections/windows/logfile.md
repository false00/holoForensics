...
- In archive collection, reuses the shared VSS snapshot when `$LogFile` is collected with `$MFT`, INDX, SRUM, Registry, USN, EVTX, Browser Artifacts, and/or Jump Lists for the same volume.
