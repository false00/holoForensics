...
- Reuses the archive workflow's shared VSS snapshot when EVTX is collected with Registry, USN, MFT, `$LogFile`, INDX, SRUM, and/or Browser Artifacts for the same volume.
