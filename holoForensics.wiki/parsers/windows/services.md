...
Artemis-backed Windows parser for service configuration data discovered in offline `SYSTEM` hives.
...
- Writes JSONL service configuration records emitted by the vendored Artemis parser runtime.
